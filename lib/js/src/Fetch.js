...
function make(method_, headers, body, referrer, $staropt$star, mode, credentials, cache, redirect, $staropt$star$1, keepalive, signal) {
  ...
  return (function () {
      ...
      if (partial_arg$6) {
        tmp.referrerPolicy = partial_arg$6[0];
      }
      if (partial_arg$5) {
        tmp.mode = partial_arg$5[0];
      }
      if (partial_arg$4) {
        tmp.credentials = partial_arg$4[0];
      }
      if (partial_arg$3) {
        tmp.cache = partial_arg$3[0];
      }
      if (partial_arg$2) {
        tmp.redirect = partial_arg$2[0];
      }
      if (partial_arg$1) {
        tmp.integrity = partial_arg$1[0];
      }
      if (partial_arg) {
        tmp.keepalive = partial_arg[0];
      }
      if (signal) {
        tmp.signal = signal[0];
      }
