...
fetch("/api/hello", Fetch.RequestInit.make(/* Post */2, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined)(/* () */0)).then((function (prim) {
          return prim.text();
        })).then((function (text) {
        return Promise.resolve((console.log(text), /* () */0));
      }));
...
fetch("/api/hello", Fetch.RequestInit.make(/* Post */2, Caml_option.some(Js_dict.fromList(/* :: */[
                      /* tuple */[
                        "Content-Type",
                        "application/json"
                      ],
